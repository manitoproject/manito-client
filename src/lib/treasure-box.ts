...
export const findTreasureByName = (name?: string) => {
  return TREASURESBOX_EMOJI_MAP.find((treasure) => treasure.name === name);
};

export const TREASURESBOX_EMOJI_MAP: {
  title: string;
  desc: string;
  imgUrl: string;
  name: Treasure;
