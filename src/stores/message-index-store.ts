...
const useMessageIndexStore = create<MessageState>()(
  devtools((set) => ({
    list: INIT_LIST,
    actions: {
...
export const useMessageList = () => useMessageIndexStore((state) => state.list);

export const useMessageActions = () =>
  useMessageIndexStore((state) => state.actions);
