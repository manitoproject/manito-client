const theme = {
  ...
  colors: {
    ...
    'brown-600': '#804D19',
    'brown-700': '#603E19',
    'treasure-teal-100': '#C7E1D9',
    'treasure-teal-300': '#7ABAAB',
    'treasure-teal-500': '#19807A',
    'treasure-teal-700': '#386663',
    'mint-600': '#00D593',
  },
};
export type FontName = keyof ThemeType['fontFamily'];
export type FontNameWithoutAppleFont = Exclude<FontName, 'AppleSDGothicNeo'>;
